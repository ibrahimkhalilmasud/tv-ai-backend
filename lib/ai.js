...
// model: "claude" | "gemini"
export async function generateAnswer(model, question, contextChunks) {
  if (model === "gemini") return answerWithGemini(question, contextChunks);
  return answerWithClaude(question, contextChunks);
}
